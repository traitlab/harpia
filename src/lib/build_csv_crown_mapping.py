...
class BuildCSV:
    # -------------------------------------------------------------------------
    def __init__(self, features_path, dsm_path, aoi_path=None, aoi_index=1, aoi_qualifier="", buffer_feature=3, takeoff_coords=None, takeoff_coords_projected=False):
    ...
    def run(self, output_folder, output_filename):
        ...
        merged_gdf = gpd.GeoDataFrame(waypoints, geometry='geometry', crs=features.crs)
