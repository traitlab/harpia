...
class CreateKMZ:
    ...
    def __init__(self):
        # File path
        self.wpmz_dir = Path(config.output_folder) / config.output_filename / "wpmz"
        ...
        if config.debug_mode == False:
            self.kmz_file_path = (
                Path(config.output_folder) / config.output_filename / f"{dji_name}.kmz"
            )
        else:
            ...
            self.kmz_file_path = (
                ...
                / f"{dji_name}_{current_datetime}.kmz"
            )
